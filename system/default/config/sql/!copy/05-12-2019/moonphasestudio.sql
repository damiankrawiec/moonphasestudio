...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 05 Gru 2019, 20:58
...
(22, 15, 22, 0, 'Treść stopki', '', '<div>Wszelkie prawa zastrzeżone &amp; 2019</div>\r\n<div><a href=\"https://moonphasestudio.com\">www.moonphasestudio.com</a></div>\r\n<p></p>\r\n<div>Projekt i realizacja: <a href=\"https://internet.media.pl\" title=\"Strony internetowe, e-sklepy, serwisy WWW, projekty i wykonanie\" target=\"_blank\" rel=\"noopener\">www.internet.media.pl</a></div>', '', '', '', '', 1, 'on', '', '2019-11-30', '2019-11-30 10:22:01', '2019-12-05 20:49:18'),
...
(35, 10, 18, 0, 'Tytuł sekcji', 'PORTFOLIO', NULL, '', '', '', '', 5, 'on', 'Oferta/portfolio', '2019-12-03', '2019-12-03 11:17:01', '2019-12-05 20:46:42'),
...
(3, 0, 'PORTFOLIO', 'portfolio', '', '', 'container-fluid portfolio', 3, 'on', '', '2019-11-17 10:07:54', '2019-12-05 20:46:20'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=276 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
