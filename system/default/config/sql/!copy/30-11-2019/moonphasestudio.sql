...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 30 Lis 2019, 10:19
...
(2, 14, 0, 'col-12 col-lg-6 col-xl-4', '', '2019-11-30 09:46:53', '2019-11-30 11:01:05'),
(3, 15, 0, 'col-12 col-lg-6 col-xl-2', '', '2019-11-30 09:47:28', '2019-11-30 11:01:13'),
(4, 16, 0, 'col-12 col-lg-12 col-xl-6', '', '2019-11-30 10:22:17', '2019-11-30 10:56:51');
...
(20, 13, 14, 0, 'Dane firmy w stopce', 'Informacje kontaktowe', '<div><i class=\"fal fa-map-marked-alt\"></i> Adres:<br />Poděbradova 869<br />547 01 N&aacute;chod<br />Regon: 05793149<br />NIP: CZ684031060<br />Czech Republic<br /><strong>Poznań, Polska</strong></div>\r\n<div><i class=\"fal fa-phone\"></i> <a href=\"tel:+48794634882\">+48 794 634 882</a></div>\r\n<div><i class=\"fal fa-mailbox\"></i> office(at)moonphasestudio.com</div>', '', '', '', '', 1, 'on', 'Formatowanie HTML', '2019-11-30', '2019-11-30 09:44:36', '2019-11-30 10:34:08'),
(21, 14, 15, 0, 'Mapa strony w stopce', 'Mapa strony', NULL, '', '', '', '', 1, 'on', 'Tożsame z menu głównym', '2019-11-30', '2019-11-30 09:45:06', '2019-11-30 09:50:42'),
(22, 15, 16, 0, 'Treść stopki', '', '<div>Wszelkie prawa zastrzeżone &amp; 2019</div>\r\n<div><a href=\"https://moonphasestudio.com\">www.moonphasestudio.com</a></div>', '', '', '', '', 1, 'on', '', '2019-11-30', '2019-11-30 10:22:01', '2019-11-30 10:48:23');
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=148 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
