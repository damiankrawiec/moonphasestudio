...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 30 Lis 2019, 19:45
...
(20, 13, 20, 0, 'Dane firmy w stopce', 'Informacje kontaktowe', '<div><i class=\"fal fa-map-marked-alt\"></i> Adres:<br />Poděbradova 869<br />547 01 N&aacute;chod<br />Regon: 05793149<br />NIP: CZ684031060<br />Czech Republic<br /><strong>Poznań, Polska</strong></div>\r\n<div><i class=\"fal fa-phone\"></i> <a href=\"tel:+48794634882\">+48 794 634 882</a></div>\r\n<div><i class=\"fal fa-mailbox\"></i> office(at)moonphasestudio.com</div>', '', '', '', '', 1, 'on', 'Formatowanie HTML', '2019-11-30', '2019-11-30 09:44:36', '2019-11-30 20:05:10'),
(21, 14, 21, 0, 'Mapa strony w stopce', 'Mapa strony', NULL, '', '', '', '', 1, 'on', 'Tożsame z menu głównym', '2019-11-30', '2019-11-30 09:45:06', '2019-11-30 20:04:07'),
(22, 15, 22, 0, 'Treść stopki', '', '<div>Wszelkie prawa zastrzeżone &amp; 2019</div>\r\n<div><a href=\"https://moonphasestudio.com\">www.moonphasestudio.com</a></div>', '', '', '', '', 1, 'on', '', '2019-11-30', '2019-11-30 10:22:01', '2019-11-30 20:03:33'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=192 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
