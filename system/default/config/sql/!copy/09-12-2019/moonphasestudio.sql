...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 09 Gru 2019, 18:26
...
(1, 1, 1, 0, 'Slider główny', '', NULL, '', '', '', '', 1, 'on', 'off', '', '2019-11-16', '2019-11-16 09:32:24', '2019-11-28 17:01:57'),
...
(40, 10, 18, 0, 'Tytuł sekcji', 'FOODSOFT', NULL, '', '', '', '', 6, 'on', 'off', 'Foodsoft - szczegóły portfolio', '2019-12-07', '2019-12-07 11:25:27', '2019-12-09 19:16:55'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=354 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(33, 19, 4, '', '', 1, NULL, '2019-12-09 19:23:07', '2019-12-09 19:24:54'),
(34, 19, 2, '', '', 4, NULL, '2019-12-09 19:23:19', '2019-12-09 19:24:54'),
(35, 19, 11, '', '', 3, NULL, '2019-12-09 19:23:51', '2019-12-09 19:24:54'),
(37, 19, 1, '', '', 2, NULL, '2019-12-09 19:24:01', '2019-12-09 19:24:54');
