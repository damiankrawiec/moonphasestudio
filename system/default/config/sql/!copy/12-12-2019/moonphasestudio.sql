...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 12 Gru 2019, 09:59
...
(4, 0, 'KONTAKT', 'kontakt', '', '', 'container', 4, 'on', 'off', '', '2019-11-17 15:10:28', '2019-12-11 21:15:01'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=431 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
