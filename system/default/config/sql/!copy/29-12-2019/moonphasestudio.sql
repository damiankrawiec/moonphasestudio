...
--
-- Host: 127.0.0.1:3306
-- Czas generowania: 29 Gru 2019, 20:45
...
) ENGINE=InnoDB AUTO_INCREMENT=142 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
...
(2, 0, 'O NAS', 'o-nas', '', '', 'container-fluid', 2, 'on', 'off', '', '2019-11-17 10:07:28', '2019-12-16 18:31:07'),
...
CREATE TABLE IF NOT EXISTS `im_section_object` (
  ...
  KEY `object_id` (`object_id`)
) ENGINE=InnoDB AUTO_INCREMENT=462 DEFAULT CHARSET=utf8 COLLATE=utf8_polish_ci;
